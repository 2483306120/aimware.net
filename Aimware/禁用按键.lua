...
local configtext = gui.Text(gui.Reference("Settings", "Configurations", "Manage Configurations"), "🌟取消禁用按键")
local luacheckbox = gui.Checkbox(gui.Reference("Settings", "Lua Scripts", "Manage Scripts"), _, "", 0)
local luatext = gui.Text(gui.Reference("Settings", "Lua Scripts", "Manage Scripts"), "🌟取消禁用按键")

configcheckbox:SetPosX(568)
configcheckbox:SetPosY(-43)
configtext:SetPosX(475)
